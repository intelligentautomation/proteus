...
/**
 * @author ccrick
 * @version $Id: BoxEditor.java 1 2011-07-16 23:22:47Z dcollins $
 */
public class BoxEditor extends RigidShapeEditor
{
    ...
    protected void assembleTextureControlPoints(DrawContext dc)
    {
        ...
        else if (selectedFace == 5)            // bottom
        {
            ...
            LLeft = new Vec4(-1 + shape.getOffsets(5, 2)[0], -1, -1 + shape.getOffsets(5, 2)[1]);
            LRight = new Vec4(1 + shape.getOffsets(5, 3)[0], -1, -1 + shape.getOffsets(5, 3)[1]);
        }
    ...
    protected void moveTexture(Point previousMousePoint, Point mousePoint)
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            shape.setOffset(selectedFace, i, newOffset[0], newOffset[1]);
        }
    }
