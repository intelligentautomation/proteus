...
/**
 * @author ccrick
 * @version $Id: CylinderEditor.java 1 2011-07-16 23:22:47Z dcollins $
 */
public class CylinderEditor extends RigidShapeEditor
{
    ...
    protected void assembleTextureControlPoints(DrawContext dc)
    {
        ...
        if (selectedFace == 0)            // cylinder top
        {
        ...
        else if (selectedFace == 1)       // cylinder bottom
        {
        ...
        else if (selectedFace == 2)            // cylinder core
        {
    ...
    protected void moveTextureCorner(Point previousMousePoint, Point mousePoint, Integer corner)
    {
        ...
        if (this.selectedFace == 0)    // Cylinder top
        {
            rightRay = new Vec4(1, 0, 0);
            upRay = new Vec4(0, 1, 0);
        }
        else if (this.selectedFace == 1)    // Cylinder bottom
        {
            rightRay = new Vec4(-1, 0, 0);
            upRay = new Vec4(0, 1, 0);
        }
        else if (this.selectedFace == 2)    // Cylinder core
        {
            rightRay = new Vec4(1, 0, 0);
