 ...
 *
 * @author dcollins
 * @version $Id: AnalyticSurface.java 254 2011-12-20 18:23:36Z dcollins $
 */
    ...
    protected static class ClampToGroundSurface extends AnalyticSurfaceObject
    {
        ...
        protected void drawOutline(DrawContext dc)
        {
            if (!dc.isPickingMode())
            {
                ...
                dc.getGL().glColor4ub(
                    (byte) color.getRed(), (byte) color.getGreen(), (byte) color.getBlue(), (byte) alpha);
            }
    ...
    protected static class ShadowSurface extends AnalyticSurfaceObject
    {
        ...
        protected void drawOutline(DrawContext dc)
        {
            if (!dc.isPickingMode())
            {
                ...
                dc.getGL().glColor4ub((byte) 0, (byte) 0, (byte) 0, (byte) alpha);
            }
