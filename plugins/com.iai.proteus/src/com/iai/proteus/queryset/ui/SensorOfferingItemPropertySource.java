 ...
 *
 */
public class SensorOfferingItemPropertySource implements IPropertySource {

	private SensorOfferingItem sensorOfferingItem;
	 ...
	 * Default constructor
	 */
	public SensorOfferingItemPropertySource() {
	 ...
	 * @param offering
	 */
	public SensorOfferingItemPropertySource(SensorOfferingItem offering) {
		this.sensorOfferingItem = offering;
	}
	...
	public Object getPropertyValue(Object id) {
		...
		SensorOffering sensorOffering = sensorOfferingItem.getSensorOffering();
	 ...
	 */
	public SensorOfferingItem getQueryOffering() {
		return sensorOfferingItem;
	}

	/**
	 * @param queryOffering the queryOffering to set
	 */
	public void setQueryOffering(SensorOfferingItem queryOffering) {
		this.sensorOfferingItem = queryOffering;
	}
